# AMD-BC-250-Utilities-and-File
Here are all the useful links and files to proceed with developing the project involving the construction of a Steam Machine using the well-known AMD BC 250.

Section 1: English | Sezione 2: Italiano
Tutorials from the web | Tutorial dal web

[Section 1]

My site with all the links and files (If you don't see them all, it's because it's under construction):
(https://facxa-digit.github.io/AMD-BC-250-Utilities-and-File)

Description:
- File BIOS:
  "o" or "Original" -> Original Bios | "P3" -> Stable - BIOS MOD | "P5" -> Beta - BIOS MOD
  Where the word "Steam" appears in the BIOS file name, it means that the Steam logo is displayed during the board's startup.

Guide:
- BIOS/Mod Installation
  (https://www.youtube.com/watch?v=dieD-CuBQr0)

- BazziteOS Installation + Overclocking Guide:
  (https://www.youtube.com/watch?v=YuBmGF536II&t=3s)
...
- NVMe SSD — whichever one you can find; 500GB, 1TB, or 2TB will all work fine.
...
- Fan:
  ...
  - ARGB FAN Asincrone HUB Controller:
    (https://it.aliexpress.com/item/1005008365111427.html)
  
- (2-in-1) Wi-Fi Bluetooth adapter:
  https://amzn.eu/d/0d2R1Glw
  You would need a Bluetooth receiver to connect to your monitor/TV,
  or a specific Ugreen DisplayPort to HDMI cable,
  as some people are experiencing issues with the onboard audio.
  (When connected via Bluetooth, it works perfectly; 
  I use it by connecting it to a Bluetooth speaker.)
...
Descrizione:
- File BIOS:
  "o" o "Original" -> Bios Originale | "P3" -> Stabile - BIOS MOD | "P5" -> Beta - BIOS MOD
  Dove appare la parola "Steam" nel nome del file BIOS, significa che il logo di Steam viene visualizzato durante l'accensione della scheda.
...
  (Quando è collegato via Bluetooth, funziona perfettamente; 
  io lo utilizzo collegandolo a una cassa Bluetooth.)
